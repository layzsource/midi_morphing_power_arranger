...
"""
Enhanced MIDI Morphing Visualizer - Step 5: Advanced Lighting and Visual Effects (FIXED)
...
try:
    ...
    # FIXED: Added missing QActionGroup import
...
# FIXED: Enhanced geometry library with better error handling
class GeometryLibrary:
    ...
    def _create_base_shapes(self):
        ...
        try:
            ...
            # FIXED: Create cube without subdivision that causes errors
            cube = pv.Box(bounds=[-1, 1, -1, 1, -1, 1])
            # Use extract_surface and triangulate instead of subdivide
            try:
                cube_surface = cube.extract_surface()
                cube_triangulated = cube_surface.triangulate()
                # Try to increase resolution by extracting and refining
...
# FIXED: Enhanced Audio Analyzer with better error handling
...
# FIXED: Enhanced MIDI Handler with better error handling
