...
class PerformanceAwareMainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        # Status bar with performance indicators        # Performance indicators
    ...
    def _do_midi_reconnect(self):
        ...
        if self.midi_handler.start(self.config.MIDI_PORT):
            self.statusBar().showMessage("MIDI reconnected successfully", 3000)
            print("MIDI reconnected successfully")
        else:
            self.statusBar().showMessage("MIDI reconnection failed", 3000)
    ...
    def _reset_performance_stats(self):
        ...
        self.statusBar().showMessage("Performance statistics reset", 2000)
    ...
    def _export_performance_data(self):
        ...
        try:
            ...
            self.statusBar().showMessage(f"Performance data exported to {filename}", 3000)
        except Exception as e:
    ...
    def _show_performance_warning(self, warning):
        ...
        self.statusBar().showMessage(f"⚠️ {warning}", 5000)  # Show for 5 seconds
